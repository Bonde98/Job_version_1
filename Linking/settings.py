"""
Django settings for Linking project.
...
SECRET_KEY = 'django-insecure-6wk()ubyxive!!1(c7#xux)hl&2ex6+q($ozajsm-cnr=)t$np'
...
ROOT_URLCONF = 'Linking.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'Linking' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'Linking.wsgi.application'
...
STATIC_URL = "/static/"
STATICFILES_DIRS = [
    os.path.join(BASE_DIR,'Linking/static')
]
# Definir le nouveau utilisateur
